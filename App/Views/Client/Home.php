    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-6">
                ...
                <p>Chúng tôi luôn nỗ lực để mang đến những dịch vụ tốt nhất cho bạn. Với đội ngũ chuyên nghiệp và tận
                    tâm, chúng tôi cam kết mang đến sự hài lòng cho khách hàng.</p>
                ...
                <div class="row my-5">
                    <div class="col-6 col-md-6">
                        <div class="feature">
                            ...
                            <p>Chúng tôi cung cấp dịch vụ giao hàng nhanh chóng và miễn phí cho mọi đơn hàng. Hãy trải
                                nghiệm sự tiện lợi này!</p>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="feature">
                            ...
                            <p>Với giao diện thân thiện và dễ sử dụng, bạn có thể dễ dàng tìm kiếm và đặt hàng chỉ trong
                                vài cú nhấp chuột.</p>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-lg-5 ps-lg-5">
                ...
                <p>Chúng tôi cung cấp dịch vụ tư vấn và cung cấp máy ảnh chất lượng cao, phù hợp với nhu cầu và sở thích
                    của bạn. Hãy để chúng tôi giúp bạn ghi lại những khoảnh khắc đáng nhớ.</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="product-item-sm d-flex">
                    <div class="thumbnail">
                        <img src="../public/assets/client/images/may-anh-sony-alpha-a6600-kit-18-135mm-oss-den-removebg-preview.png"
                            alt="Camera Image" class="img-fluid">
                    </div>
                    <div class="pt-3">
                        <h3>Máy Ảnh DSLR Canon</h3>
                        <p>Máy ảnh DSLR Canon với độ phân giải cao và khả năng chụp ảnh chuyên nghiệp, phù hợp cho người
                            mới và nhiếp ảnh gia chuyên nghiệp.</p>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="product-item-sm d-flex">
                    <div class="thumbnail">
                        <img src="../public/assets/client/images/2_may-anh-ky-thuat-so-sony-zv1-e10-chinh-hang_02fac3295a6740288ab48ebb96b3426b_master-removebg-preview.png"
                            alt="Camera Image" class="img-fluid">
                    </div>
                    <div class="pt-3">
                        <h3>Máy Ảnh Mirrorless Sony</h3>
                        <p>Máy ảnh Mirrorless Sony nhỏ gọn với công nghệ tiên tiến, cho phép bạn chụp ảnh và quay video
                            chất lượng cao.</p>
                        <p><a href="#">Đọc Thêm</a></p>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="product-item-sm d-flex">
                    <div class="thumbnail">
                        <img src="../public/assets/client/images/may-anh-sony-dsc-wx800-removebg-preview.png"
                            alt="Camera Image" class="img-fluid">
                    </div>
                    <div class="pt-3">
                        <h3>Máy Ảnh Fujifilm X Series</h3>
                        <p>Dòng máy ảnh Fujifilm X Series với thiết kế cổ điển và chất lượng ảnh vượt trội, lý tưởng cho
                            các chuyến du lịch và chụp ảnh nghệ thuật.</p>
                        <p><a href="#">Đọc Thêm</a></p>
                    </div>
                </div>
            </div>
